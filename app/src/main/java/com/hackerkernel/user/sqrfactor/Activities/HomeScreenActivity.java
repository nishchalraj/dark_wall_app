...
import com.hackerkernel.user.sqrfactor.Fragments.ModalSheet;
import com.hackerkernel.user.sqrfactor.R;
import com.hackerkernel.user.sqrfactor.Fragments.TrophyFragment;

public class HomeScreenActivity extends ToolbarActivity {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()){
                    ...
                    case 1:
                        ...
                        Intent i1 = new Intent(HomeScreenActivity.this, MessagesActivity.class);
                        startActivity(i1);
                        break;

                    case 2:
                        tab.setIcon(R.drawable.notification_filled);
                        Intent i2 = new Intent(HomeScreenActivity.this, NotificationsActivity.class);
                        startActivity(i2);
                        break;
                    ...
                    case 3:
                        ...
                        //Intent i4 = new Intent(HomeScreenActivity.this, MessagesActivity.class);
                        //startActivity(i4);
                        break;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (id == R.id.navigation_credits){
                    Intent j = new Intent(HomeScreenActivity.this,CreditsActivity.class);
                ...
                Toast.makeText(HomeScreenActivity.this, menuItem.getTitle(), Toast.LENGTH_LONG).show();
                return false;
            }
        });
    }
