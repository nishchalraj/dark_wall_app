...
import com.hackerkernel.user.sqrfactor.Activities.ArticleActivity;
import com.hackerkernel.user.sqrfactor.Activities.CommentsPageActivity;
import com.hackerkernel.user.sqrfactor.Activities.DesignActivity;
import com.hackerkernel.user.sqrfactor.Activities.LaunchCompetitionActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                pop.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            ...
                            case R.id.comp:
                                Intent i = new Intent(getContext(), LaunchCompetitionActivity.class);
                                startActivity(i);
                                return true;
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getContext(), CommentsPageActivity.class);
                startActivity(i);
