...
import com.hackerkernel.user.sqrfactor.Activities.BasicDetailsActivity;
import com.hackerkernel.user.sqrfactor.Activities.EducationDetailsActivity;
import com.hackerkernel.user.sqrfactor.Activities.OtherDetailsActivity;
import com.hackerkernel.user.sqrfactor.Activities.ProfessionalActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getContext(),BasicDetailsActivity.class);
                startActivity(i);
            }
        });
