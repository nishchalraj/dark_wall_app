...
public class CompetitionClass {
    ...
    public CompetitionClass(String id, String slug, String competitionName, String startTimeAgo, String imageUrl, String lastSubmissionDate, String lastRegistrationDate, String prize, String competitionType) {
        this.id = id;
        this.slug = slug;
