...
import com.hackerkernel.user.sqrfactor.Fragments.BluePrintFragment;
import com.hackerkernel.user.sqrfactor.Fragments.FollowersFragment;
import com.hackerkernel.user.sqrfactor.Fragments.FollowingFragment;
import com.hackerkernel.user.sqrfactor.Fragments.PortfolioFragment;
import com.hackerkernel.user.sqrfactor.Fragments.PostFragment;
        ...
        tablayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()){
                    ...
                    case 1:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragmentContainer, new PortfolioFragment()).commit();
                        break;
...
//                startActivity(i);
        ...
        portfolio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent j = new Intent(Profile.this,PortfolioFragment.class);
//                startActivity(j);
