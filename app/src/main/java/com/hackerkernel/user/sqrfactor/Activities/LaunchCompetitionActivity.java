...
public class LaunchCompetitionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), Launch2Activity.class);
                startActivity(i);
            }
        });
    ...
    public void onClick(final View v) {
        ...
        new DatePickerDialog(LaunchCompetitionActivity.this, listener, cyear, cmonth, cdate).show();
    }
